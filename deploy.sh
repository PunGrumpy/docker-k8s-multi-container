...
docker push $DOCKER_ID/multi-client:latest && docker push $DOCKER_ID/multi-client:$SHA
docker push $DOCKER_ID/multi-server:latest && docker push $DOCKER_ID/multi-server:$SHA
docker push $DOCKER_ID/multi-worker:latest && docker push $DOCKER_ID/multi-worker:$SHA
