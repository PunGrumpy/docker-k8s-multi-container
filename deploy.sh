...
docker push $DOCKER_USERNAME/multi-client:latest && docker push $DOCKER_USERNAME/multi-client:$SHA
docker push $DOCKER_USERNAME/multi-server:latest && docker push $DOCKER_USERNAME/multi-server:$SHA
docker push $DOCKER_USERNAME/multi-worker:latest && docker push $DOCKER_USERNAME/multi-worker:$SHA
